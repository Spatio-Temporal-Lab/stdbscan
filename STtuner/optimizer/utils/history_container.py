...
from optimizer.utils import MAXINT, SUCCESS
from optimizer.utils import Configuration, ConfigurationSpace
from optimizer.utils import get_logger
from optimizer.utils.multi_objective import Hypervolume, get_pareto_front
from optimizer.utils.visualization.plot_convergence import plot_convergence
from optimizer.utils import  get_transform_function
...
class HistoryContainer(object):
    ...
    def get_importance(self, config_space=None, return_list=False):
        ...
        try:
            ...
            raise
        from optimizer.utils.fanova import fANOVA
        from terminaltables import AsciiTable
